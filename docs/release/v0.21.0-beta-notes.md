# Varen CAD v0.21.0-beta（Prerelease 草稿）

> 发布前把本文件内容粘贴到 GitHub Release 说明；zip 与 .sha256 两个 asset 同时上传。
> 注意：`packaging/release/VarenCAD-win64-0.1.0.zip` 是 09-15 的旧构建（内部版本号仍是旧命名）。
> 正式上传前按 `docs/release/release-checklist.md` §3 用当前 VERSION 重新打包，替换下方校验值。
